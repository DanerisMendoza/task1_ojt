...
class ApiController extends Controller
{
    ...
    */
    ...
    public function createUser(Request $request)
    {
        ...
        $user->save();
        // $serverAddress = 'wss://cloud-linen-climb.glitch.me/?user-agent=Mozilla';
        // $client = new Client($serverAddress);
        // $messageObject = ['channel' => 'channel1', 'message' => 'hello from laravel'];
        // $jsonString = json_encode($messageObject);
